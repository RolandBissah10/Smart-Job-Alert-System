...
# TEMPORARY - diagnosing why every alerts_collection record still has
# email_sent=False after moving to SendGrid. Surfaces the exact exception
# Render's environment produces without needing dashboard/log access.
